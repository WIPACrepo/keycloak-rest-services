...
REMOVAL_MESSAGE = "You have been removed from {group_path} because members of this group " \
                  "must also be members of an institution belonging to {experiments} " \
                  "experiment(s)." + MESSAGE_FOOTER


async def deprovision_mailing_lists(removal_grace_days, send_notifications, keycloak_client, dryrun=False):
