...
async def test_update_institutionless_users(keycloak_bootstrap):
    ...
    await add_user_group('/institutions/IceCube/Authorlist_false', 'remove-in-disabled-authorlist', rest_client=keycloak_bootstrap)
